...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    whatWasBuilt:
      'A full-stack web app (Next.js, Supabase, n8n, Claude) with 14 active AI workflows, 13 Supabase tables, and all 465 Ontario Math curriculum expectations loaded as verified structured data. No curriculum content is ever generated by AI. Two-stage planning workflow: diagnostic-informed lesson skeletons reviewed before full expansion; sections like Teacher Notes and Differentiation are generated on demand. Dependency-aware revision cascade, curriculum coverage tracker, export to PDF/DOCX/Google Docs, and admin analytics dashboard.',
    proofPoint:
